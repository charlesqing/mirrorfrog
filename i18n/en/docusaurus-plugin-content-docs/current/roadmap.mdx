...
|---|---|---|---|
| 2026-H2 | 🔄 [**NVIDIA Rubin R200 Volume Deployment**](/en/docs/cards/nvidia/rubin-r200) | NVIDIA | 288GB HBM4, 50 PFLOPS FP4, NVLink 6, H2 capacity ramp |
...
| 2026-H2 | 🔄 [**AMD MI450X (Value)**](/en/docs/cards/amd/mi400) | AMD | 432GB HBM4, FP4/FP8 training + inference |
| 2026-H2 | 🔄 [**AMD MI430X (HPC)**](/en/docs/cards/amd/mi430x) | AMD | 432GB HBM4, FP32/FP64 support, sovereign AI + HPC |
...
<div className="timeline-td-section">
  ...
  <div className="timeline-td-event"><strong>NVIDIA B200</strong> — Launched</div>
  <div className="timeline-td-event"><strong>AMD MI355X</strong> — Launched</div>
  <div className="timeline-td-event"><strong>Google TPU v6e</strong> — GA</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">2025 H2</div>
  <div className="timeline-td-event"><strong>NVIDIA B300 Ultra</strong> — Launched</div>
  <div className="timeline-td-event"><strong>AWS Trainium 3</strong> — GA</div>
  <div className="timeline-td-event"><strong>Google TPU Ironwood</strong> — Launched</div>
  <div className="timeline-td-event"><strong>Huawei Ascend 910C</strong> — In Production</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">2026 H1</div>
  <div className="timeline-td-event"><strong>NVIDIA Vera Rubin R200</strong> — Full Production</div>
  <div className="timeline-td-event"><strong>NVIDIA RTX Spark</strong> — Launched</div>
  <div className="timeline-td-event"><strong>Huawei Ascend 950PR/DT</strong> — In Production</div>
  <div className="timeline-td-event"><strong>Cambricon MLU690</strong> — Shipping</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">2026 H2</div>
  <div className="timeline-td-event"><strong>Rubin NVL72</strong> — Shipping</div>
  <div className="timeline-td-event"><strong>AMD MI400 Series</strong> — MI455X / MI450X / MI430X</div>
  <div className="timeline-td-event"><strong>AMD Helios Rack</strong> — Expected H2</div>
  <div className="timeline-td-event"><strong>Qualcomm AI 200</strong> — Rack Inference</div>
  <div className="timeline-td-event"><strong>RTX Spark Retail</strong> — Fall</div>
  <div className="timeline-td-event"><strong>Ascend 950 SuperPoD</strong> — WAIC 2026</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">2027</div>
  <div className="timeline-td-event"><strong>Qualcomm AI 250</strong> — Near-Memory</div>
  <div className="timeline-td-event"><strong>NVIDIA Rubin Ultra / Feynman</strong> — Outlook</div>
  <div className="timeline-td-event"><strong>AMD MI500</strong> — Outlook</div>
  <div className="timeline-td-event"><strong>Google TPU v8</strong> — Outlook</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">Late 2027</div>
  <div className="timeline-td-event"><strong>Cerebras WSE-4</strong> — Post-IPO</div>
  <div className="timeline-td-event"><strong>Huawei Ascend 960</strong> — Roadmap</div>
  <div className="timeline-td-event"><strong>Intel Jaguar Shores</strong> — ❌ Cancelled</div>
</div>

<div className="timeline-td-section">
  <div className="timeline-td-marker">2028</div>
  <div className="timeline-td-event"><strong>Huawei Ascend 970</strong> — Roadmap Q4</div>
</div>
...
Found incorrect or missing information? [Submit an Issue](https://github.com/charlesqing/mirrorfrog/issues)!
