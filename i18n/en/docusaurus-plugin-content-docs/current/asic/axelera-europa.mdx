...
- [Google Edge TPU](/tpu/google-edge-tpu) — Google (TPU Tensor Processor)
- [FuriosaAI RNGD](/asic/furiosaai-rngd) — FuriosaAI (ASIC Dedicated Accelerator)
- [NVIDIA GPU / CUDA](/gpu/nvidia-cuda) — NVIDIA (GPU Graphics Processor)
- [d-Matrix Corsair](/asic/dmatrix-corsair) — d-Matrix (ASIC Dedicated Accelerator)
