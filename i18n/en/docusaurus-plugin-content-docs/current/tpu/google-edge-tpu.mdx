...
- [Hailo-8 / Hailo-15](/npu/hailo-8l) — Hailo (NPU Neural Processing Unit)
- [TsingMicro TX510](/asic/tsingmicro-rpu) — TsingMicro (ASIC dedicated accelerator)
- [Intel NPU (Neural Processing Unit)](/npu/intel-npu) — Intel (NPU Neural Processing Unit)
- [AMD Ryzen AI NPU](/npu/amd-ryzen-ai) — AMD (NPU Neural Processing Unit)
- [Qualcomm Hexagon NPU](/npu/qualcomm-hexagon) — Qualcomm (NPU Neural Processing Unit)
