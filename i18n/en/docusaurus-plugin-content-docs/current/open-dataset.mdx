...
description: 'MirrorFrog publishes the full specs of 233 AI compute cards as an open dataset (chips.json / pricing.json) for research, secondary development, and cross-comparison. Includes field documentation, license, and citation guidance.'
...
| --- | --- | --- |
| `chips.json` | Full specs of 233 chips (architecture, process, compute, memory, bandwidth, TDP, etc.) | [/chips.json](/chips.json) |
