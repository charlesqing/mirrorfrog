...
- [Huawei Ascend](/docs/npu/huawei-ascend) — Huawei (Cloud Training + Inference)
- [Qualcomm Hexagon NPU](/docs/npu/qualcomm-hexagon) — Qualcomm (Mobile NPU)
- [Hailo-8 / Hailo-15](/docs/npu/hailo-8l) — Hailo (Edge AI Inference)
