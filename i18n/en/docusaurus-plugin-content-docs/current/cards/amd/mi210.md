...
- [AMD Instinct MI250 (128GB HBM2e OAM)](/docs/cards/amd/mi250) — Same-series flagship
- [AMD Instinct MI300X (192GB HBM3)](/docs/cards/amd/mi300x) — Successor
- [AMD Instinct MI325X (256GB HBM3E)](/docs/cards/amd/mi325x) — Successor
- [AMD Instinct MI355X (288GB HBM3E 8 TB/s)](/docs/cards/amd/mi355x) — Successor
- [AMD Instinct MI400 (CDNA Next 432GB HBM4)](/docs/cards/amd/mi400) — Latest
- [AMD Ryzen AI Max (Strix Halo XDNA 2)](/docs/cards/amd/ryzen-ai-max) — Consumer comparison
- [NVIDIA A100 (40GB / 80GB HBM2e)](/docs/cards/nvidia/a100) — Main competitor
- [NVIDIA H100 (80GB HBM3 3.35 TB/s)](/docs/cards/nvidia/h100) — Successor competitor
- [Architecture: GPU General-Purpose Parallel](/docs/architectures/arch-gpu) — GPU architecture
