...
const config: Config = {
  // ========== 基础信息 ==========
  title: 'AI 算力卡百科 | 173 款 AI 芯片规格对比',
  titleDelimiter: ' | ',
  tagline: '173 款 AI 算力卡完整规格对比 · NVIDIA / AMD / 华为昇腾 · 2025-2026 行业洞察',
  ...
  headTags: [
      ...
      innerHTML: `
        (function() {
          function updateTitle() {
            ...
            var defaultTitles = {
              zh: 'AI 算力卡百科 | 173 款 AI 芯片规格对比',
              en: 'AI Compute Cards Wiki | 173 AI Chips Specs Compared'
            };
    ...
    // ---- 基础 SEO Meta ----
    {tagName: 'meta', attributes: {name: 'description', content: '完整收录 173 款 AI 算力卡规格参数与性能对比，覆盖 NVIDIA H100/H200/B200/GB300/Rubin、AMD MI300X/MI400、华为昇腾910B/950/960/970、寒武纪 MLU370 等主流 AI 芯片，提供算力卡选型参考。'}},
    ...
    {tagName: 'meta', attributes: {name: 'theme-color', content: '#6c5ce7'}},
    ...
    {tagName: 'meta', attributes: {property: 'og:image:alt', content: 'MirrorFrog AI 算力卡百科 - 173 款 AI 芯片规格对比'}},
    ...
    {tagName: 'meta', attributes: {name: 'twitter:description', content: '完整收录 173 款 AI 算力卡规格参数与性能对比，覆盖 NVIDIA H100/H200/B200/GB300/Rubin、AMD MI300X/MI400、华为昇腾910B/950/960/970 等主流 AI 芯片。'}},
    {tagName: 'meta', attributes: {name: 'twitter:image', content: 'https://mirrorfrog.com/img/og-cover.png'}},
    {tagName: 'meta', attributes: {name: 'twitter:image:alt', content: 'MirrorFrog AI 算力卡百科 - 173 款 AI 芯片'}},
      ...
      '@graph': [
        {
          ...
          url: 'https://mirrorfrog.com',
          description: '173 款 AI 算力卡完整规格对比、深度分析、选型指南。覆盖 NVIDIA、AMD、Intel、Google、AWS、华为昇腾、寒武纪等主流 AI 加速芯片。2025-2026 行业洞察持续更新。',
        ...
        },
        {
          ...
          description: '完整收录 173 款 AI 算力卡规格参数与性能对比，覆盖 NVIDIA H100/H200/B200/GB300/Rubin、AMD MI300X/MI400、华为昇腾910B/950/960/970、寒武纪 MLU370 等主流 AI 芯片，提供算力卡选型参考。',
        },
      ],
    })},
  ],
