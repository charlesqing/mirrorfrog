...
**2026 年 6 月最新动态**：完成对 MiniMax M3、智谱 GLM-5.2、阿里 Qwen3.5 的 Day-0 适配，国产 AI 软件生态快速成熟。
...
## 2026 年 6 月最新适配（Day-0 支持）

摩尔线程在 2026 年 6 月实现对多个主流 LLM 的 **Day-0 适配**，标志着国产 GPU 软件生态快速成熟。
