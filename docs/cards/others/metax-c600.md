...
| 项目 | 状态 |
|------|------|
| **量产时间** | **2026 年 5 月**已实现量产 |
| **制程** | 国内 7nm |
| **显存** | 144 GB HBM3e |
| **FP8 算力** | 约 1,000 TFLOPS |
| **合规** | 已完成**国家安全性和稳定性测试** |
| **互联** | 自研 MetaXLink，已在千卡规模应用（带宽接近 H100 水平），正推进万卡部署 |

> 📌 **采购定位**：C600 是沐曦**当前可采购的在售旗舰**。在下一代 C700 于 2027 年下半年量产之前，C600 承担国产高端 GPU 的过渡供给角色——对需要**当下就能落地**的国产算力项目，它是可评估的选项之一。
