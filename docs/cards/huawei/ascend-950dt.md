...
| **HBM 带宽** | **4 TB/s** |
| **互联带宽** | **2 TB/s**（HCCS 协议） |
| **MXFP4 算力** | **2,007 / 1,784 / 1,561 TFLOPS**（144GB / 128GB / 112GB 配置） |
| **FP8 / HiF8 / MXFP8 算力** | **1,034 / 919 / 804 TFLOPS** |
| **INT8 算力** | **1,034 / 919 / 804 TOPS** |
| **BF16/FP16 算力** | **547 / 486 / 425 TFLOPS** |
| **TF32 算力** | **273 / 243 / 212 TFLOPS** |
| **TDP** | 500 W |
| **PCIe** | Gen 5 ×16 |
| **发布时间** | **2026年8月**（华为云上线；原计划 Q4，已提前） |
| **价格** | ~¥12-15 万/卡（推测） |

> 📌 **数据订正（2026-08 联网核实，来源《昇腾 950 NPU 架构白皮书》）**：本站此前记载 FP8 1 PFLOPS、FP4 2 PFLOPS、INT8 ~2,000 TOPS。白皮书精确值为：
> - **FP8 1,034 TFLOPS**（宣传口径取整 1 PFLOPS ✅ 无误）
> - **FP4 2,007 TFLOPS**（宣传口径取整 2 PFLOPS ✅ 无误）
> - **INT8 1,034 TOPS** — ⚠️ 原记 ~2,000 TOPS **高估近一倍**，INT8 与 FP8 共用 Tensor Core，两者同值
> - **BF16/FP16 547 TFLOPS**（原记 ~500，基本一致）
>
> 950DT 与 950PR **共享同一计算核心**，差异仅在内存子系统（HiZQ 2.0 高带宽 vs HiBL 1.0 成本优化）。因此同配置下两者算力完全相同，950DT 的优势体现在 **4 TB/s 带宽**（950PR 为 1.6 TB/s）带来的 Decode 与训练性能。
...
## 市场动态：HBM 挤压下的报价上调（2026-09 更新）

据 Reuters / Bloomberg 2026-09-10 报道，HBM 成本攀升正直接推高国产加速卡报价：

| 产品 | 报价变化 | 备注 |
|------|----------|------|
| **昇腾 950DT** | **> ¥25 万/卡**（较两个月前 +20~50%） | Bloomberg 称 3 个月涨约 60%，报价**对标 NVIDIA B200** |
| 昇腾 950PR | ¥6 万 → **> ¥8 万**（+30%） | 年初至今 |
| 昇腾 910C | ¥9 万 → **> ¥11 万**（+22%） | 存量型号同样上调 |
| 寒武纪 690 / 沐曦 / 天数智芯 | **+20~30%** | 同期上调 |

**关键判断**：

- **上市窗口不变**：华为公开表述中，950DT 仍是 **2026 年第四季度**上市
- **瓶颈在 HBM 而非逻辑**：SMIC 可支撑年产超 100 万颗昇腾芯片，但国产 HBM（CXMT / HiZQ）产能仅够约 25~30 万颗成品加速器，缺口约六成
- **内存口径**：昇腾 950 系列采用自研内存——950PR 为 **HiBL 1.0**、950DT 为 **HiZQ 2.0**，均未披露制造方
- **定价锚点变化**：950DT 报价与 B200 对齐，意味着国产旗舰的定价逻辑已从"替代品折价"转向"供给稀缺溢价"

> ⚠️ 上述报价为**渠道指示价**，实际成交随订单规模、是否捆绑整机/网络/配套采购而变化。

## 外部链接

- [腾讯新闻：昇腾950DT芯片8月上线](https://news.qq.com/rain/a/20260611A01Y8F00)
- [华为官网：昇腾950超节点真机亮相WAIC 2026](https://www.huawei.com/cn/news/2026/7/atlas-950-superpod)
- [腾讯新闻：华为昇腾950超节点亮相 1024卡 FP4算力2EFLOPS](https://new.qq.com/rain/a/20260718A0BUEM00)
