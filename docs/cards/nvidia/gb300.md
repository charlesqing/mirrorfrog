...
sidebar_label: GB300
description: NVIDIA GB300 Grace Blackwell 300 详尽规格：72-GPU NVL72 机柜、ConnectX-9 1.6T 网络、Arm Vera CPU、B300 Ultra GPU。
keywords: [NVIDIA GB300, Grace Blackwell 300, NVL72, ConnectX-9, Vera CPU, B300 Ultra, 机柜级 AI]
---
...
**NVIDIA GB300 (Grace Blackwell 300)** 是 NVIDIA 第三代 **Grace Blackwell 超级芯片**（Superchip），**2025 H2 发布**。将 **B300 Ultra GPU**（升级版 Blackwell）通过 **NV-HBI 高速接口**与 **Arm Grace/Vera CPU** 配对，**单 Superchip 算力 = 1 GPU + 1 CPU**。72 颗 GB300 组成 **NVL72 机柜**，**NVLink 5 + ConnectX-9 1.6T 网络** 互联，是 **NVIDIA 数据中心 AI 的旗舰机柜级产品**。
