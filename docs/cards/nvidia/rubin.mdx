...
NVIDIA 在 Hot Chips 2026 把叙事从规格切换到实测：Vera Rubin NVL72 跑 **DeepSeek-V4-Pro** 的 AgentX 基准，官方口径为**每兆瓦吞吐最高 30×**、**token 成本最高降低 35×**（对比 GB300 NVL72）。优势最大的正是**高交互性 / 低延迟**场景。
...
- **88 核**自研核（代号 Olympus，ARM v9.2，非 Neoverse 公版）
