...
- **Anthropic 战略合作**（2026-07-22）：Anthropic 将部署**最高 2GW 的 MI450 系列 GPU（Helios 机柜）**，首批 1GW 于 **2027 上半年**上线；AMD 承诺向 Anthropic 战略股权投资**最高 50 亿美元**。
- **OpenAI + Meta**：自 2025 年 10 月起合计锁定 **12GW+** GPU 采购承诺（含 MI400 与 MI355X）。
